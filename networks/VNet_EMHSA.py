    ...
    def __init__(self, n_stages, n_filters_in, n_filters_out, normalization='none'):
        ...
        for i in range(n_stages):
            ...
            if normalization == 'batchnorm':
                ops.append(nn.BatchNorm3d(n_filters_out,momentum=0.01))
...
class ConvBlock_2D(nn.Module):
    def __init__(self, n_stages, n_filters_in, n_filters_out, normalization='none'):
        ...
        for i in range(n_stages):
            ...
            if normalization == 'batchnorm':
                ops.append(nn.BatchNorm2d(n_filters_out,momentum=0.01))
            elif normalization == 'groupnorm':
                ops.append(nn.GroupNorm(num_groups=16, num_channels=n_filters_out))
            elif normalization == 'instancenorm':
...
class DownsamplingConvBlock_2D(nn.Module):
    def __init__(self, n_filters_in, n_filters_out, stride=2, normalization='none'):
        super(DownsamplingConvBlock_2D, self).__init__()
...
class Upsampling_function(nn.Module):
    def __init__(self, n_filters_in, n_filters_out, stride=2, normalization='none', mode_upsampling=1):
        ...
        ops = []
        if mode_upsampling == 0 or mode_upsampling == 1:
...
class Encoder(nn.Module):
    def __init__(self, n_channels=3, n_classes=2, n_filters=16, normalization='none', has_dropout=False, has_residual=False):
        ...
        self.dropout = nn.Dropout3d(p=0.0, inplace=False)
...
class VNet(nn.Module):
    ...
    def forward(self, input,need_features = False):
        features = self.encoder(input)
        out_seg1 = self.decoder1(features)
        if need_features:
            return out_seg1, features
        else:
            return out_seg1
...
class E_MHSA(nn.Module):
    ...
    def __init__(self, dim, out_dim=None, head_dim=32, qkv_bias=True, qk_scale=None,
        ...
        if sr_ratio > 1:
            ...
            self.norm = nn.BatchNorm1d(dim, eps=self.NORM_EPS,momentum=0.01)
...
class InterSampleAttention(torch.nn.Module):
    ...
    def __init__(self, input_dim=256, hidden_dim=1024):
        ...
        # self.encoder_layers = torch.nn.TransformerEncoderLayer(input_dim, 4, hidden_dim,dropout=0.0)
        self.encoder_layers = E_MHSA(input_dim)
...
class CAML3d_v1_EMHSA(nn.Module):
    """
    ...
    def __init__(self, n_channels=3, n_classes=2, n_filters=16, normalization='none', has_dropout=False,
        ...
        super(CAML3d_v1_EMHSA, self).__init__()
        self.cma_type = cma_type
        self.insert_idx = insert_idx
    ...
    def forward(self, input, with_feature = True):
...
if __name__ == '__main__':
    # model = CAML3d_v1_EMHSA(n_channels=1, n_classes=2, normalization='batchnorm', has_dropout=False, ).cuda()
    # model.train()
